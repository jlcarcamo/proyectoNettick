...
<h1 class="col-sm-10 col-md-offset-4">Solicitud de trabajo</h1>
<br>
<br>

<form class="form-horizontal col-sm-10 col-md-offset-3"  method="POST">
	<div class="form-group">
			<label class="col-sm-2 control-label">Nombre</label>
		<div class="col-sm-4">
			<input class="form-control" type="text" name="nombre_contacto" value="" required/>
		</div>
	</div>
	...
	<div class="form-group">
		...
		<div class="col-sm-4">
			<input class="form-control" type="text" name="apellido_contacto" value="" required/>
		</div>
	</div>
	...
	<div class="form-group">
		...
		<div class="col-sm-4">
			<input class="form-control" type="text" name="cargo" value="" required/>
		</div>
	</div>
	...
	<div class="form-group">
		...
		<div class="col-sm-4">
			<input class="form-control" type="text" name="telefono_contacto" value="" required/>
		</div>
	</div>
	...
	<div class="form-group">
		...
		<div class="col-sm-4">
			<input class="form-control" type="text" name="correo" value="" required/>
		</div>
	</div>
	...
	<div class="form-group">
	    <div class="col-sm-offset-2 col-sm-8">
	      	<button type="submit" class="btn btn-primary btn-lg col-md-offset-2"  name="btnEnviar">Enviar</button>
	    </div>
    </div>
</form>